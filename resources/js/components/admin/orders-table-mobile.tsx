...
const OrdersTableMobile: React.FC<OrdersTableMobileProps> = ({ orders, onViewOrder }) => {
                ...
                orders.map((order) => (
                    <Card key={order.id} className="bg-gray-800 border-gray-700">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            {/* Collapsible Details */}
                            <Collapsible open={expandedOrder === order.id} onOpenChange={() => setExpandedOrder(expandedOrder === order.id ? null : order.id)}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="space-y-2">
                                            {order.items.map((item, index) => (
                                                <div key={index} className="flex gap-3 p-2 bg-gray-700 rounded">
